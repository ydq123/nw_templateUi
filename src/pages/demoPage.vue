<template>
  <div
    id="demoPage"
    class="bg-f5"
    style="padding-top:75px;padding-bottom: 80px;"
  >
    <!-- 页面头部组件 -->
    <nw-fixed-header
      title="头部导航"
      @headBackeHandle="backHandle"
      @threeClockHandle="ClockHandle"
      @backHomeHandle="HomeHandle"
    >
    ...
    <div class="bg-white mt20 pb20">
      ...
      <nw-module-top
        :isSort="true"
        :isSreen="true"
        @inputTopBtn="testInputTopBtn"
        @changeTab="testChangeTab"
        @changeSortItem="testChangeSortItem"
        @submitScreen="testSubmitScreen"
        @resetScreen="testResetScreen"
      >
      </nw-module-top>
    </div>
    <h2 class="pt20 pb20 borderButtomE8 bg-white mt20" @click="openFlowView">
      打开流程页面组件
    </h2>
    <div class="bg-white mt20 pb20">
    ...
    <nw-map-pop
      :isMapPop="mapPop"
      @checkTheme="testCheckTheme"
      @zdcBtnShow="testZdcBtnShow"
    ></nw-map-pop>
    <!-- 选择组织--组件 -->
    <nw-unit-pop
      :popShow="unitPop"
      :popUserInfo="userInfo"
      @overlay="testOverlay"
    ></nw-unit-pop>
    <!-- 右侧弹出筛选组件 -->
    ...
    <nw-bot-button
      :zyBtn="dbZyBtn"
      :cyBtn="dbCyBtn"
      :twoZCyBtn="dbTwoZCyBtn"
      :zIconBtn="botbtnobj"
      @cliIconRBtn="testCliIconRBtn"
      @cliIconItemBtn="testCliIconItemBtn"
    ></nw-bot-button>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    _this.userInfo = {
      ...
      orgName: "广州天河供电局",
      nameFullPath:
        "中国南方电网有限责任公司/广州供电局有限公司/广州天河供电局",
      orgCode: "080020",
