        ...
        <van-list :immediate-check="false" v-model="loading" :offset="30" :finished="finished" finished-text="没有更多了"
          ...
          <div class="list ">
            ...
            <!-- 变电站ID			id
							...
							变电站类型			subType -->
            <div class="task-list borderButtomE8" @click="openFunctionalLocation(itme, index)" m="click" :key="index"
              v-for="(itme, index) in bdList">
              <div class="row p15">
                <van-checkbox class=" pr15 " v-model="itme.checked"></van-checkbox>
                <div class=" row al-c ">
