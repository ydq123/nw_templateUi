		...
		props: {
			...
			videoTypeArr: {
				...
				default: () => [{
					type: 0,
					typeKey: 'mp4',
					fmImg: require("@/assets/image/fileTypeImg/video.png")
				}]
			},
			imgTypeArr: {
				type: Array,
			...
			txtTypeArr: {
				...
				default: () => [{
						type: 3,
						typeKey: 'doc',
						fmImg: require("@/assets/image/fileTypeImg/word.png")
					}, {
						type: 3,
						typeKey: 'docx',
						fmImg: require("@/assets/image/fileTypeImg/word.png")
					},
					{
						type: 3,
						typeKey: 'xls',
						fmImg: require("@/assets/image/fileTypeImg/xlsx.png")
					}, {
						type: 3,
						typeKey: 'xlsx',
						fmImg: require("@/assets/image/fileTypeImg/xlsx.png")
					},
					{
						type: 3,
						typeKey: 'ppt',
						fmImg: require("@/assets/image/fileTypeImg/text.png")
					}, {
						type: 3,
						typeKey: 'pptx',
						fmImg: require("@/assets/image/fileTypeImg/text.png")
					},
					{
						type: 3,
						typeKey: 'pdf',
						fmImg: require("@/assets/image/fileTypeImg/pdf.png")
					}, {
						type: 3,
						typeKey: 'pdfx',
						fmImg: require("@/assets/image/fileTypeImg/pdf.png")
					},
					{
						type: 3,
						typeKey: 'zip',
						fmImg: require("@/assets/image/fileTypeImg/zip.png")
					}, {
						type: 3,
						typeKey: 'text',
						fmImg: require("@/assets/image/fileTypeImg/text.png")
		...
		methods: {
			...
			checkFileType: function(fileType) {
				...
				return {
					type: 5,
					typeKey: 'null',
					fmImg: require("@/assets/image/fileTypeImg/null.png")
				};
			},
			/* 计算base 64  */
